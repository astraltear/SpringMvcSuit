...
<p>Recommended: Using a Web Developer tool such a Firebug to inspect the client/server interaction 한글</p>
<div id="tabs">
	<ul>
...
$(document).ready(function() {
	...
	$("form.readXmlForm").submit(function() {
		...
		$.ajax({ 
			type: "POST", 
			url: form.attr("action"), 
			data: "<?xml version=\"1.0\" encoding=\"UTF-8\" standalone=\"yes\"?><messageConvertBean><foo>bar</foo><fruit>apple</fruit></messageConvertBean>", 
